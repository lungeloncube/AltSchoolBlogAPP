...
# Create a class for users, Inheriting from db.model
class User(db.Model, UserMixin):
    ...
    # define a method to get a token for resetting the password
...
# Create a Post class to hold our posts, Inheriting from db.model
class Post(db.Model):
    id = db.Column(db.Integer, primary_key=True)
